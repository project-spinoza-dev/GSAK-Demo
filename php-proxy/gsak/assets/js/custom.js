...
(function($){
	$(window).load(function(){
	    ...
	    $(".pop-custom-form").css("display","block");
...
//Search on keywords list category

$(".selectcat select" ).change(function(){
	
	$('.search-box-key').val(null);
	$(".categories-search li").removeClass("selected");
	$(this).find("option:selected").each(function(){


		 if($(this).attr("value")=="datascience.txt" ){
                $(".datasciencecont").show();
				$(".facebookcont").hide();
				$(".microsoftcont").hide(); 
				
  		 	}
		else if($(this).attr("value")=="science.txt" ){
				$(".facebookcont").show();
				$(".datasciencecont ").hide();
				$(".microsoftcont").hide();
				
            }
        else if($(this).attr("value")=="Eurocup2016.txt"){
			$(".microsoftcont").show();
			$(".datasciencecont").hide();
			$(".facebookcont").hide();
...
$(".categories-search li").click(function(){

	//alert('test');
	$(this).addClass("selected");
	$(this).css("font-weight","bold");
		myList = "";
        $(".categories-search li.selected").each(function(){
        ...
        sublist = myList.substring(0, myList.length-2);

		$(".search-box-key").val(sublist);
